    ...
    <div className='max-w-screen-2xl mx-auto xl:px-24 px-4'>
      ...
      <div className='mt-5'>
        <div className='search-box p-2 text-center mb-2'>
          <input type='text' name='search' id='search' className='py-2 pl-3 border focus:outline-none lg:w-6/12 mb-2 w-full' onChange={(e) => setSearchText(e.target.value)}/>
      ...
      <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-12 my-12 items-center'>
        {
          ...
          salary.map((data) => (
            <div className='shadow px-4 py-8' key={data.id}>
              ...
              <p className='flex font-medium text-blue text-lg'>{data.salary}</p>
